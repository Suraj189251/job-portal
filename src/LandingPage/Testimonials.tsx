...
import {testinonials} from "../Data/Data";
const Testimonials = () => {
  return <div className="mt-20 pb-5 ">
        ...
        {
            testinonials.map((data,index)=><div key={index} className="flex flex-col gap-3 w-[23%] border-bright-sun-400 p-3 border rounded-xl mt-10">
                ...
                <div className="text-xs text-mine-shaft-300">{data.testinomial}</div>
                </div>)
        }
       </div>
    </div>
