...
const Subscribe=()=>{
    return <div className="mt-20 flex item-center bg-mine-shaft-900 mx-20 py-3 rounded-xl justify-around">
        ...
        <div className="flex gap-4 rounded-xl background-mine-shaft-700 px-3 py-2 items-center">
            <TextInput
