...
const ApplyJobComp=()=>{
   ...
   const handleSubmit=()=>{
    ...
    return <> <div className="w-2/3 mx-auto">
        ...
        <LoadingOverlay className="!fixed" visible={submit} zIndex={1000} overlayProps={{radius:'sm',blur: 2 }} loaderProps={{color: 'bright-sun.4', type:'bars'}}/>

        <div className="flex justify-between">
            <div className="flex gap-2 items-center">
                <div className="p-3 background-mine-shaft-800 rounded-xl">
                    <img className="h-14" src={`/icon/Google.png`} alt=""/>
                </div>
                <div className="flex flex-col gap-1">
                    <div className="font-semibold text-2x">Software Engineer</div>
                    <div className="text-lg text-mine-shaft-300">Google &#x2022; 3 days ago &#x2022; 58 Applicants</div>
                </div>
            </div>
        </div>
        <Divider my="xl"/>
        ...
        <div className="flex flex-col gap-5">
            ...
            <FileInput readOnly={Preview} variant={Preview?"unstyled":"default"} className={`${Preview?"text-mine-shaft-300 font-semibold":""}`} withAsterisk leftSection={<IconPaperclip stroke={1.5}/>} label="Input label" placeholder="Input description" leftSectionPointerEvents="none" />
    ...
    <MantineNotification className={`"!border-bright-sun-400 -translate-y-20 !fixed top-0 left-[35%] z-[1000] transition duration-300 ease-in-out ${submit?"translate-y-0":"-translate-y-20"}`} icon={<IconCheck style={{width: rem(20), height: rem(20)}}/>} color="teal" withBorder title="Application Submitted!" mt="md" withCloseButton={false}>
