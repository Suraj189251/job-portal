    ...
    <div className="flex justify-between">
            <div className="flex gap-2 items-center">
                ...
                <div className="flex flex-col gap-1">
                    <div className="font-semibold text-2x">Softwarengineer</div>
        ...
        <Divider my="xl"/>
        <div>
            <div className="text-lg font-semibold mb-5">Required Skills</div>
        ...
        <div>
            ...
            <div className="flex gap-2 items-center">
                <div className="p-3 bg-mine-shaft-800 rounded-xl">
                    <img className="h-8" src={`/icon/Google.png`} alt=""/>
                </div>
            ...
            <div className="text-mine-shaft-300 justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia voluptatibus eos dignissimos expedita nam, soluta quas officiis. Accusantium dolorum impedit cumque minus.</div>
        </div>
    </div>
